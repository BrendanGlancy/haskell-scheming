...
/* package haskell-scheming-0.1.0.0 */
#ifndef VERSION_haskell_scheming
#define VERSION_haskell_scheming "0.1.0.0"
#endif /* VERSION_haskell_scheming */
#ifndef MIN_VERSION_haskell_scheming
#define MIN_VERSION_haskell_scheming(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_scheming */
...
#define CURRENT_COMPONENT_ID "haskell-scheming-0.1.0.0-inplace-haskell-scheming"
